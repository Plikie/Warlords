...
public class IllusionCrossfire extends GameMap {
    ...
    public List<Option> initMap(GameMode category, LocationFactory loc, EnumSet<GameAddon> addons) {
        ...
        options.add(new WaveDefenseOption(Team.RED, new StaticWaveList()
                .add(1, new RandomSpawnWave(6, 10 * SECOND, null)
                        // basic
                ...
                .add(5, new RandomSpawnWave(6, 10 * SECOND, null)
                        //basic
                        .add(0.8, Mob.ZOMBIE_LANCER)
                ...
                .add(11, new RandomSpawnWave(8, 10 * SECOND, null)
                        //basic
                ...
                .add(15, new RandomSpawnWave(10, 10 * SECOND, null)
                        //basic
                ...
                .add(21, new RandomSpawnWave(15, 10 * SECOND, null)
                        //basic
                        ...
                        .add(0.01, Mob.FIRE_SPLITTER)
                        .add(0.02, Mob.RIFT_WALKER)
                        // champion
                        .add(0.1, 1, Mob.VOID_JAILER)
                        .add(0.1, 1, Mob.LANTERN_DREDGER)
                        .add(0.05, 1, Mob.BARNACLE_BRUTE)
                        .add(0.05, 1, Mob.ABYSS_WATCHER)
                )
                .add(25, new RandomSpawnWave(15, 10 * SECOND, null)
                        //basic
                        ...
                        // forgotten
                        .add(0.05, 1, Mob.VOID_JAILER)
                        .add(0.05, 2, Mob.LANTERN_DREDGER)
                        .add(0.05, 1, Mob.BARNACLE_BRUTE)
                        .add(0.05, 1, Mob.ABYSS_WATCHER)
                )
                ...
                .add(31, new RandomSpawnWave(15, 10 * SECOND, null)
                        //basic
                        .add(0.4, Mob.ZOMBIE_LAMENT)
                        .add(0.1, Mob.PIG_SHAMAN)
                        .add(0.08, Mob.ILLUMINATION)
                        ...
                        .add(0.05, 2, Mob.LANTERN_DREDGER)
                        .add(0.05, 1, Mob.BARNACLE_BRUTE)
                        .add(0.05, 1, Mob.SOULBINDER)
                        .add(0.05, 1, Mob.ABYSS_WATCHER)
                )
                .add(35, new RandomSpawnWave(15, 10 * SECOND, null)
                        //basic
                        ...
                        // forgotten
                        .add(0.07, 1, Mob.VOID_JAILER)
                        .add(0.07, 2, Mob.LANTERN_DREDGER)
                        .add(0.07, 2, Mob.BARNACLE_BRUTE)
                        .add(0.05, 1, Mob.SOULBINDER)
                        .add(0.05, 1, Mob.ABYSS_WATCHER)
                )
                ...
                .add(41, new RandomSpawnWave(15, 10 * SECOND, null)
                        //basic
                        //.add(0, Mobs.ZOMBIE_LANCER)
                        ...
                        // forgotten
                        .add(0.001, 3, Mob.NIGHTMARE_ZOMBIE)
                        .add(0.08, 1, Mob.VOID_JAILER)
                        .add(0.08, 2, Mob.LANTERN_DREDGER)
                        .add(0.08, 1, Mob.BARNACLE_BRUTE)
                        .add(0.05, 1, Mob.SOULBINDER)
                        .add(0.05, 1, Mob.ABYSS_WATCHER)
                        .add(0.05, 1, Mob.DEVOURING_IDOL)
                )
                .add(45, new RandomSpawnWave(15, 10 * SECOND, null)
                        //basic
                        ...
                        .add(0.04, Mob.SKELETAL_SORCERER)
                        .add(0.04, Mob.FIRE_SPLITTER)
                        .add(0.0, Mob.RIFT_WALKER)
                        // forgotten
                        .add(0.01, 3, Mob.NIGHTMARE_ZOMBIE)
                        .add(0.1, 2, Mob.VOID_JAILER)
                        .add(0.1, 2, Mob.LANTERN_DREDGER)
                        .add(0.1, 1, Mob.BARNACLE_BRUTE)
                        .add(0.05, 1, Mob.SOULBINDER)
                        .add(0.05, 1, Mob.ABYSS_WATCHER)
                        .add(0.05, 1, Mob.DEVOURING_IDOL)
                )
                ...
                .add(51, new RandomSpawnWave(20, 5 * SECOND, null)
                        //basic
                        //.add(0, Mobs.ZOMBIE_LANCER)
                        ...
                        .add(0.1, 1, Mob.VOID_JAILER)
                        .add(0.1, 2, Mob.LANTERN_DREDGER)
                        .add(0.1, 2, Mob.BARNACLE_BRUTE)
                        .add(0.05, 1, Mob.SOULBINDER)
                        .add(0.05, 1, Mob.ABYSS_WATCHER)
                        .add(0.05, 1, Mob.DEVOURING_IDOL)
                )
                .add(55, new RandomSpawnWave(20, 5 * SECOND, null)
                        //basic
                        //.add(0, Mobs.ZOMBIE_LANCER)
                        //.add(0, Mobs.ZOMBIE_LAMENT)
                        //.add(0, Mobs.BASIC_SKELETON)
                ...
                .add(61, new RandomSpawnWave(25, 5 * SECOND, null)
                        ...
                        .add(0.1, 2, Mob.LANTERN_DREDGER)
                        .add(0.1, 2, Mob.BARNACLE_BRUTE)
                        .add(0.05, 2, Mob.SOULBINDER)
                        .add(0.05, 1, Mob.ABYSS_WATCHER)
                        .add(0.05, 1, Mob.DEVOURING_IDOL)
                        .add(0.05, 1, Mob.SILTSTALKER)
                )
                .add(65, new RandomSpawnWave(25, 5 * SECOND, null)
                        //basic
                        //.add(0, Mobs.ZOMBIE_LANCER)
                        //.add(0, Mobs.ZOMBIE_LAMENT)
                        //.add(0, Mobs.BASIC_SKELETON)
                        ...
                        .add(0.1, Mob.SCRUPULOUS_ZOMBIE)
                        .add(0.1, Mob.SKELETAL_SORCERER)
                        .add(0.07, Mob.FIRE_SPLITTER)
                        .add(0.07, Mob.RIFT_WALKER)
                        // forgotten
                        .add(0.02, Mob.NIGHTMARE_ZOMBIE)
                        ...
                        .add(0.1, 2, Mob.BARNACLE_BRUTE)
                        .add(0.05, 2, Mob.SOULBINDER)
                        .add(0.05, 2, Mob.ABYSS_WATCHER)
                        .add(0.05, 2, Mob.DEVOURING_IDOL)
                        .add(0.05, 1, Mob.SILTSTALKER)
                )
                ...
                .add(71, new RandomSpawnWave(25, 5 * SECOND, null)
                        ...
                        .add(0.05, 2, Mob.ABYSS_WATCHER)
                        .add(0.05, 2, Mob.DEVOURING_IDOL)
                        .add(0.05, 2, Mob.SILTSTALKER)
                )
                .add(75, new RandomSpawnWave(25, 5 * SECOND, null)
                        //basic
                        //.add(0, Mobs.ZOMBIE_LANCER)
                        //.add(0, Mobs.ZOMBIE_LAMENT)
                        //.add(0, Mobs.BASIC_SKELETON)
                ...
                .add(85, new RandomSpawnWave(25, 5 * SECOND, null)
                        //basic
                        //.add(0, Mobs.ZOMBIE_LANCER)
                        //.add(0, Mobs.ZOMBIE_LAMENT)
                        //.add(0, Mobs.BASIC_SKELETON)
                        ...
                        // champion
                        .add(0.1, 2, Mob.VOID_JAILER)
                        .add(0.1, 3, Mob.LANTERN_DREDGER)
                        .add(0.1, 3, Mob.BARNACLE_BRUTE)
                        .add(0.1, 2, Mob.SOULBINDER)
                        .add(0.1, 2, Mob.ABYSS_WATCHER)
                        .add(0.1, 2, Mob.DEVOURING_IDOL)
                        .add(0.1, 2, Mob.SILTSTALKER)
                )
                ...
                .add(95, new RandomSpawnWave(30, 5 * SECOND, null)
                        //basic
                        //.add(0, Mobs.ZOMBIE_LANCER)
                        //.add(0, Mobs.ZOMBIE_LAMENT)
                        //.add(0, Mobs.BASIC_SKELETON)
                        ...
                        .add(0.1, 3, Mob.LANTERN_DREDGER)
                        .add(0.1, 3, Mob.BARNACLE_BRUTE)
                        .add(0.1, 3, Mob.SOULBINDER)
                        .add(0.1, 3, Mob.ABYSS_WATCHER)
                        .add(0.1, 2, Mob.DEVOURING_IDOL)
                        .add(0.1, 2, Mob.SILTSTALKER)
                )
                ...
                .add(101, new RandomSpawnWave(40, 5 * SECOND, null)
                        .add(0.04, Mob.ILLUMINATION)
                        .add(0.06, Mob.GOLEM_APPRENTICE)
                        .add(0.05, Mob.WITCH_DEACON)
                        .add(0.02, Mob.SLIMY_CHESS)
                        ...
                        // champion
                        .add(0.05, 2, Mob.VOID_JAILER)
                        .add(0.05, 3, Mob.LANTERN_DREDGER)
                        .add(0.05, 3, Mob.BARNACLE_BRUTE)
                        .add(0.05, 3, Mob.SOULBINDER)
                        .add(0.05, 3, Mob.ABYSS_WATCHER)
                        .add(0.05, 2, Mob.DEVOURING_IDOL)
                        .add(0.05, 2, Mob.SILTSTALKER)
                )
                ...
                .add(111, new RandomSpawnWave(45, 5 * SECOND, null)
                        ...
                        .add(0.05, 3, Mob.SOULBINDER)
                        .add(0.05, 3, Mob.ABYSS_WATCHER)
                        .add(0.05, 3, Mob.DEVOURING_IDOL)
                        .add(0.05, 3, Mob.SILTSTALKER)
                )
                ...
                .add(121, new RandomSpawnWave(45, 5 * SECOND, null)
                        ...
                        // champion
                        .add(0.05, 2, Mob.VOID_JAILER)
                        .add(0.05, 4, Mob.LANTERN_DREDGER)
                        .add(0.05, 4, Mob.BARNACLE_BRUTE)
                        .add(0.05, 3, Mob.SOULBINDER)
                        .add(0.05, 3, Mob.ABYSS_WATCHER)
                        .add(0.05, 3, Mob.DEVOURING_IDOL)
                        .add(0.05, 3, Mob.SILTSTALKER)
