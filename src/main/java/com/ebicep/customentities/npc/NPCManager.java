...
public class NPCManager {
    ...
    public static void createWeaponsManagerNPC() {
        ...
        npc.spawn(location);
        HologramDataText hologramDataText = new HologramDataText.Builder<>(ComponentBuilder.create("The Weaponsmith", NamedTextColor.GREEN).build())
                .setBillboard(Display.Billboard.CENTER)
                .build();
        HologramManager.addHologram(new Hologram.Builder("theWeaponsmith", location.clone().add(0, 2.1, 0), player -> hologramDataText)
    ...
    public static void createSupplyDropFairNPC() {
        ...
        npc.spawn(location);
        HologramDataText hologramDataText = new HologramDataText.Builder<>(ComponentBuilder.create("Supply Drop Susan", NamedTextColor.GREEN).build())
                .setBillboard(Display.Billboard.CENTER)
                .build();
        HologramManager.addHologram(new Hologram.Builder("supplyDropSusan", location.clone().add(0, .6, 0), player -> hologramDataText)
                .setVisibility(VisibilityType.ALL)
                .build());
    }
    ...
    public static void createBountyMenuNPC() {
        ...
        npc.getOrAddTrait(SkinTrait.class).setSkinName("Freminet");
        ...
        npc.spawn(location);
        HologramDataText hologramDataText = new HologramDataText.Builder<>(ComponentBuilder.create("Bounty Hunter", NamedTextColor.AQUA).build())
                .setBillboard(Display.Billboard.CENTER)
                .build();
    ...
    public static void createTreasureHuntVendorNPC() {
        ...
        npc.getOrAddTrait(SkinTrait.class).setSkinName("MiZzaXP");
        npc.addTrait(TreasureHuntVendorTrait.class);
        LookClose lookClose = npc.getOrAddTrait(LookClose.class);
        lookClose.setPerPlayer(true);
        lookClose.toggle();
        npc.data().set(NPC.Metadata.NAMEPLATE_VISIBLE, false);
        npc.spawn(new Location(StatsLeaderboardManager.MAIN_LOBBY_SPAWN.getWorld(), -15.5, 81, 144.5, 0, 0));
    }
    ...
    public static void createWeeklyItemTraderNPC() {
        ...
        npc.getOrAddTrait(SkinTrait.class).setSkinName("Lazulite_Ztone");
